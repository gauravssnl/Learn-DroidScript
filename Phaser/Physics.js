...
function preload()
{
	...
	game.load.spritesheet('spinner', 'Img/bluemetal_32x32x4.png', 32, 32);
	game.load.image('phaser', 'Img/phsr.png');
}
...
function create()
{
	...
	for (var i = 0; i < 50; i++)
	{
		var s = sprites.create(game.rnd.integerInRange(100, 700), 
		        game.rnd.integerInRange(32, 200), 'spinner');
	...
	//	This will set physics properties on all group children that have 
	//  a 'body' (i.e. it will skip the groupB)
