...
function preload() 
{
    ...
    //Create sound fx media players.
    //(Note: We are using native DroidScript audio players here because
    //the HTML5 audio can be unrelible on current versions of Android)
    if( navigator.userAgent.indexOf("Android")>-1 )
    {
        shot = app.CreateMediaPlayer();
    	shot.SetFile( "Snd/blaster.mp3" );
    	bang = app.CreateMediaPlayer();
    	bang.SetFile( "Snd/explosion.mp3" );
    }
...
function create() 
{
    ...
    app.ShowPopup( "Tilt device to move your ship and touch screen to fire!" );
}
...
function createAliens () 
{
    ...
    //  All this does is basically start the invaders moving. Notice 
    //we're moving the Group they belong to, rather than the invaders directly.
