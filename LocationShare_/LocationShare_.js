...
btnA = app.CreateButton( "Gone", 1.0/3, -1);
layB.AddChild( btnA );

btnA.SetOnTouch(function() {
	layM.SetVisibility('Hide');
});

//btnA.SetBackColor( "#ff0000" );
btnB = app.CreateButton( "Show" , 1.0/3, -1);

btnB.SetOnTouch(function() {
	layM.SetVisibility('Show');
});


layB.AddChild( btnB );
btnC = app.CreateButton( "Gradient" , 1.0/3, -1);

btnC.SetOnTouch(function() {
	layM.SetBackGradient('#ff0000', '#ffff00');
});
