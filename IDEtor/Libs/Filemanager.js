////////////////////////////////////////////////////////////////////////////////
// Filemanager.js                                                             //
// Copyright 2016, created by dimy44 <dimy44@dimonvideo.ru>,                  //
//                 a little bit customized by Virtuos86 <virtuos86@yandex.ru> //
////////////////////////////////////////////////////////////////////////////////
...
var _history = ['/storage/sdcard0/DroidScript'];
function history ( operation, path ) {
	// operation == "push": добавление в конец истории FM;
	// operation == "pull": взять из конца истории FM;
	if( ( typeof operation == "undefined" ) ) {
		return alert( "Undefined `operation` in calling `history`!" );
	};
	if( operation == "pull" ) {
		return _history[_history.length - 1];
	} else if( ( operation == "push" ) && ( typeof path != "undefined" ) ) {
		if ( _history.length > ( 20 - 1 ) ) {
...
function OnTouchSelectFile() {
	...
	FileManager(OpenFile, ['.js'], history( "pull" ));
}
